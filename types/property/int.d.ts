...
export interface paths {
  "/externalSystem/{extSystemCode}/businessEvents": {
    ...
    get: operations["getBusinessEventsByExternalSystem"];
  };
  "/externalSystem/{extSystemCode}/hotels/{hotelId}/businessEvents": {
    ...
    get: operations["getBusinessEvents"];
  };
}
...
export interface definitions {
  ...
  businessEventModuleType:
    ...
    | "StayRecords"
    | "RoomRotation";
  businessEventDetailsType: definitions["businessEventDetailType"][];
...
export interface operations {
  ...
  getBusinessEventsByExternalSystem: {
    parameters: {
      path: {
        /** External system code which will be used to dequeue the events */
    ...
    responses: {
      ...
      200: {
        headers: {};
        schema: definitions["businessEvents"];
      };
      /** BusinessEventsByExternalSystem not found. */
      204: never;
      400: responses["400"];
      401: responses["401"];
      403: responses["403"];
