...
export interface paths {
  ...
  "/services/backOfficeOperations/status": {
    ...
    get: operations["pingBackOfficeOperationsService"];
  };
}
...
export interface definitions {
  ...
  businessDate: {
    ...
    hotels?: definitions["hotelActiveEndOfDaysType"];
    links?: definitions["links"];
    warnings?: definitions["warningsType"];
  };
  /** @description Collection of hotels and its active end of days. */
  hotelActiveEndOfDaysType: definitions["hotelActiveEndOfDayType"][];
...
export interface operations {
  ...
  getBusinessDate: {
    ...
    responses: {
      ...
      200: {
        headers: {};
        schema: definitions["businessDate"];
      };
  ...
  pingBackOfficeOperationsService: {
    ...
    responses: {
      ...
      /** pingBackOfficeOperationsService not found. */
      204: never;
      400: responses["400"];
      401: responses["401"];
      403: responses["403"];
